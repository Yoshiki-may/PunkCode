import { Home, FolderKanban, Calendar, Users, Sparkles, Newspaper, Settings, Search, MessageSquare, UserCheck, Plus, Building2 } from 'lucide-react';
...
export function DirectionSidebar({ currentView, onViewChange }: DirectionSidebarProps) {
  ...
  const menuItems = [
    // 共通機能
    { id: 'direction-home', icon: Home, label: 'Direction Board', type: 'common' },
    ...
    // AI機能
    { id: 'palss-ai', icon: Sparkles, label: 'PALSS AI for Direction', type: 'ai' },
